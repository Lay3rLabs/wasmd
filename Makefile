...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=slay3r \
		  -X github.com/cosmos/cosmos-sdk/version.AppName=slay3r \
		  -X github.com/cosmos/cosmos-sdk/version.Version=$(VERSION) \
		  -X github.com/cosmos/cosmos-sdk/version.Commit=$(COMMIT) \
		  -X github.com/CosmWasm/wasmd/app.Bech32Prefix=slay3r \
		  -X github.com/CosmWasm/wasmd/app.NodeDir=.slay3r \
...
install: go.sum
	...
	mv ${GOPATH}/bin/wasmd ${GOPATH}/bin/slay3r
